...
function onCreate()
	...
	addArt('betasloading','loading screen','A9A9A9',5,3)
	addArt('selfinsertlol','how did this get here','FFA500',5,3)
	addArt('no','diebf','A9A9A9',5,3)
	addArt('idea','funny','A9A9A9',5,3)
	addArt('tiny','funny','A9A9A9',5,3)
